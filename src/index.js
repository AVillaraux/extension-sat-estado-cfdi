...
let input = document.getElementById('cfdi')
...
const getData = () => {
  ...
  if (!input) {
    ...
    alert('Seleccione un xml y precione en el boton "Cargar archivo"', 'danger')
  }
  else {
    ...
    fr.onload = async function() {
      ...
      try{
        ...
        alert('El archivo cargado no es un xml de un CFDi, no se encuentra timbrado o cuenta con un formato que impide ser leido', 'danger')
        return
      }
...
document.getElementById("loadFile").addEventListener("click", getData)
